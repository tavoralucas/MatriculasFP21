...
<asp:Content ID="Content1" ContentPlaceHolderID="contentmain" runat="server">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card" style="border: 0px;">
                            <div class="card card-outline-info" style="border-color: black !important; margin-bottom: 0px;">
                            <div class="card-header" style="background: black !important; border-color: black !important;">
                                <h4 class="m-b-0 text-white">Matrícula 2021 - Curso Fernanda Pessoa</h4>
                            </div>
	...
	<%
		...
		if (Request.QueryString.Count > 0)
		{
			...
			MySqlConnection connedit = new MySqlConnection("server=127.0.0.1;User Id=esmeraldino;database=esmeraldino; password=*tel2000");
		...
		{
			MySqlConnection connup = new MySqlConnection("server=127.0.0.1;User Id=esmeraldino;database=esmeraldino; password=*tel2000");
		...
		{
			MySqlConnection connin = new MySqlConnection("server=127.0.0.1;User Id=esmeraldino;database=esmeraldino; password=*tel2000");
	...
	%>
      ...
      <%  
		  ...
		  MySqlConnection conn2 = new MySqlConnection("server=127.0.0.1;User Id=esmeraldino;database=esmeraldino; password=*tel2000");
