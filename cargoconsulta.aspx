<%@ Page Title="" Language="C#" MasterPageFile="main.Master" AutoEventWireup="true" CodeBehind="cargoconsulta.aspx.cs" Inherits="esmeraldino.site.cargoconsulta" %>
...
<div class="col-md-6">
      ...
      <%  
		  ...
		  sqlConsulta.CommandText = "Select *,'VAZIO' from CARGOS order by DESCRICAO";
		  ...
		  while (dados.Read())
		  {
			  ...
			  Response.Write("<td>"+
							 "<p><a class='mytooltip tooltip-effect-7' href='cargo.aspx?cmd=edit&id="+dados["ID"].ToString()+"'><i class='fa fa-edit'></i> <span class='tooltip-content2'>Alterar</span></a></p>"+
							 "  </td>");

			  Response.Write("<td>"+
							 "<p><a class='mytooltip tooltip-effect-6'href='excluir.aspx?page=cargoconsulta&cmd=CARGOS&id="+dados["ID"].ToString()+"' ><i class='fa fa-times'></i><span class='tooltip-content2'>Excluir</span> </a></p>"+
							 " "+
							 "  </td>");
