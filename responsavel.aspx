	...
	<%@ Import Namespace="RestSharp" %>
					...
					<%
						...
						if (Request.Form.Count> 0)
						{
							...
							else
							{
								...
								connin.Open();
								sqlinsert.CommandText = "insert into disci_aluno(cpf,cod_disciplina,disciplina,turma,cpf_resp,nome_resp,data_nasc_resp,email_resp,data_cadastro) values ('" + CPF_ALUNO + "',2,'Português','"+TURMA+"', '"+cpf+"','"+titular+"','" + data_nasc2 + "','" + e_mail + "',current_timestamp)";
                    ...
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <input type="text" class="form-control" required="" name="txtDATA" id="txtDATA" placeholder="dd/mm/aaaa" data-mask="99/99/9999" onkeypress="$(this).mask('00/00/0000');" maxlength="10" autocomplete="off">
